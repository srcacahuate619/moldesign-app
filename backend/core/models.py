...
class ScoreBreakdown(BaseModel):
    ...
    m5_protocol_id:       str | None = Field(None, description="Perfil M5-Zn resuelto por PDB exacto (M5_ZN_CA2_3DC3_V1 | M5_ZN_MMP9_1GKC_V1 | M5_ZN_ACE_1O86_V1). None si la corrida no es un caso de metal o el PDB no es ninguno de los tres validados.")
