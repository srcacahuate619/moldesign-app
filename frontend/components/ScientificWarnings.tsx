    ...
    <section className="space-y-2">
      {scientific.length > 0 && (
        <div className="rounded-xl border border-yellow-600/30 bg-yellow-950/20 p-4">
          <h3 className="mb-1 text-xs font-bold uppercase tracking-wider text-yellow-400">{t("z_advertencias_cientificas")}</h3>
      ...
      {technical.length > 0 && (
        <div className="rounded-xl border border-surface-800 bg-surface-950/40 p-3">
          <h3 className="mb-1 text-[10px] font-bold uppercase tracking-wider text-surface-500">{t("z_notas_integridad")}</h3>
