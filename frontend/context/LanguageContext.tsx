...
export const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  ...
  pt: {
    ...
    legal_local_first: "Local-First · Sem Telemetria · Conexões externas opcionais",
    legal_understood: "Entendido",

    login_title: "Login Local",
    login_subtitle: "O MolDesign executa o acoplamento e a análise no seu dispositivo.",
    login_username: "Nome de Usuário",
    login_password: "Senha (Mínimo 4 caracteres)",
    login_btn: "Acessar Laboratório",
    login_privacy_badge: "O cálculo é executado no seu dispositivo. As conexões externas são opcionais.",
  ...
  fr: {
    ...
    legal_local_first: "Local-First · Sans Télémétrie · Connexions externes optionnelles",
    legal_understood: "Compris",

    login_title: "Connexion Locale",
    login_subtitle: "MolDesign exécute l'amarrage et l'analyse sur votre appareil.",
    login_username: "Nom d'utilisateur",
    login_password: "Mot de passe (Min 4 caractères)",
    login_btn: "Accéder au Laboratoire",
    login_privacy_badge: "Les calculs s'exécutent sur votre appareil. Les connexions externes sont optionnelles.",
  ...
  de: {
    ...
    legal_local_first: "Local-First · Keine Telemetrie · Externe Verbindungen optional",
    legal_understood: "Verstanden",

    login_title: "Lokale Anmeldung",
    login_subtitle: "MolDesign führt Docking und Analyse auf deinem Gerät aus.",
    login_username: "Benutzername",
    login_password: "Passwort (Min. 4 Zeichen)",
    login_btn: "Labor betreten",
    login_privacy_badge: "Die Berechnung läuft auf deinem Gerät. Externe Verbindungen sind optional.",
  ...
  it: {
    ...
    legal_local_first: "Local-First · Nessuna Telemetria · Connessioni esterne opzionali",
    legal_understood: "Capito",

    login_title: "Accesso Locale",
    login_subtitle: "MolDesign esegue il docking e l'analisi sul tuo dispositivo.",
    login_username: "Nome Utente",
    login_password: "Password (Minimo 4 caratteri)",
    login_btn: "Accedi al Laboratorio",
    login_privacy_badge: "Il calcolo viene eseguito sul tuo dispositivo. Le connessioni esterne sono opzionali.",
  ...
  zh: {
    ...
    legal_tab_priv: "隐私政策",
    legal_tab_lic: "开源许可证",
    legal_local_first: "本地优先 · 无遥测 · 外部连接可选",
    legal_understood: "我知道了",

    login_title: "本地会话登录",
    login_subtitle: "MolDesign 在您的设备上运行对接与分析。",
    login_username: "用户名",
    login_password: "密码 (至少4位字符)",
    login_btn: "进入实验室",
    login_privacy_badge: "计算在您的设备上运行。外部连接为可选项。",
  ...
  ja: {
    ...
    legal_tab_lic: "ライセンス",
    legal_local_first: "ローカルファースト · 追跡なし · 外部接続は任意",
    legal_understood: "了解",

    login_title: "ローカルログイン",
    login_subtitle: "MolDesignはドッキングと解析をお使いのデバイス上で実行します。",
    login_username: "ユーザー名",
    login_password: "パスワード (4文字以上)",
    login_btn: "研究室に入る",
    login_privacy_badge: "計算はお使いのデバイス上で実行されます。外部接続は任意です。",
  ...
  ko: {
    ...
    legal_tab_lic: "라이선스",
    legal_local_first: "로컬 퍼스트 · 추적 없음 · 외부 연결은 선택",
    legal_understood: "확인함",

    login_title: "로컬 로그인",
    login_subtitle: "MolDesign은 도킹과 분석을 사용자의 기기에서 실행합니다.",
    login_username: "사용자 이름",
    login_password: "비밀번호 (4자 이상)",
    login_btn: "연구실 입장",
    login_privacy_badge: "계산은 사용자의 기기에서 실행됩니다. 외부 연결은 선택 사항입니다.",
  ...
  ru: {
    ...
    legal_local_first: "Local-First · Без телеметрии · Внешние подключения опциональны",
    legal_understood: "Понятно",

    login_title: "Локальный вход",
    login_subtitle: "MolDesign выполняет докинг и анализ на вашем устройстве.",
    login_username: "Имя пользователя",
    login_password: "Пароль (минимум 4 символа)",
    login_btn: "Войти в лабораторию",
    login_privacy_badge: "Вычисления выполняются на вашем устройстве. Внешние подключения опциональны.",
  ...
  hi: {
    ...
    legal_local_first: "Local-First · कोई टेलीमेट्री नहीं · बाहरी कनेक्शन वैकल्पिक",
    legal_understood: "समझ गया",

    login_title: "स्थानीय लॉगिन",
    login_subtitle: "MolDesign डॉकिंग और विश्लेषण आपके डिवाइस पर चलाता है।",
    login_username: "उपयोगकर्ता नाम",
    login_password: "पासवर्ड (न्यूनतम 4 वर्ण)",
    login_btn: "प्रयोगशाला में प्रवेश करें",
    login_privacy_badge: "गणना आपके डिवाइस पर चलती है। बाहरी कनेक्शन वैकल्पिक हैं।",
  ...
  ar: {
    ...
    legal_local_first: "Local-First · بدون تتبع · الاتصالات الخارجية اختيارية",
    legal_understood: "مفهوم",

    login_title: "تسجيل الدخول المحلي",
    login_subtitle: "يُجري MolDesign الالتحام والتحليل على جهازك.",
    login_username: "اسم المستخدم",
    login_password: "كلمة المرور (4 أحرف على الأقل)",
    login_btn: "الدخول إلى المختبر",
    login_privacy_badge: "تُجرى العمليات الحسابية على جهازك. الاتصالات الخارجية اختيارية.",
  ...
  tr: {
    ...
    legal_local_first: "Local-First · Telemetri Yok · Harici bağlantılar isteğe bağlı",
    legal_understood: "Anlaşıldı",

    login_title: "Yerel Giriş",
    login_subtitle: "MolDesign, yerleştirme ve analizi cihazınızda çalıştırır.",
    login_username: "Kullanıcı Adı",
    login_password: "Şifre (En az 4 karakter)",
    login_btn: "Laboratuvara Gir",
    login_privacy_badge: "Hesaplama cihazınızda çalışır. Harici bağlantılar isteğe bağlıdır.",
