...
**Vigente desde:** 13 de septiembre de 2026
**Responsable:** Johan Amezcua / amezcua-dev.com
**Contacto general y solicitudes de privacidad:** moldesign@amezcua-dev.com
**Soporte y reporte de respuestas de MolChat:** soporte-moldesign@amezcua-dev.com
...
- **Cómo reportar una respuesta.** Cada respuesta de MolChat lleva un botón **«Reportar respuesta»** que abre el programa de correo del usuario con la respuesta y el proveedor ya escritos, dirigido a **soporte-moldesign@amezcua-dev.com**. No se envía nada hasta que la persona lo manda: MolDesign no transmite conversaciones por su cuenta, tampoco para procesar un reporte.
...
Esta política se actualizará cuando cambien las funciones de red o el tratamiento de datos. La versión vigente se publicará con el código y en la página oficial del producto. Preguntas o solicitudes de privacidad: **moldesign@amezcua-dev.com**. Soporte de la aplicación y reporte de respuestas de MolChat: **soporte-moldesign@amezcua-dev.com**.
