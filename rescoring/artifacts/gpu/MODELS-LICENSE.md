<!-- GENERADO por scripts/check_model_license_boundary.py. No editar a mano. -->

# Artefactos aprendidos de MolDesign

Este directorio contiene **2 artefacto(s) aprendido(s)** propio(s):

- `model_a.joblib`
- `model_null.joblib`

Se rigen por [`../../../LICENSE-MODELS`](../../../LICENSE-MODELS), que aplica la
...
[`../../../frontend/public/legal/THIRD_PARTY_NOTICES.md`](../../../frontend/public/legal/THIRD_PARTY_NOTICES.md).
