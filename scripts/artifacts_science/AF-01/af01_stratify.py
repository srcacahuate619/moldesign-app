#!/usr/bin/env python3
"""AF-01 — auditoría de solapamiento por receptor entre desarrollo y holdout.

Reimplementación independiente del método FND-05/FND-02 (k-meros k=8 sobre
SEQRES por cadena; ver scripts/build_confirm_cohort.py y
scripts/artifacts_science/FND-05/DESIGN.md §12):
  ...
  - Estratos del holdout (contra TODAS las cadenas del pool de desarrollo):
      receptor_seen_exact      algún par de cadenas con solapamiento == 1.0
      receptor_near_identity   0.90 <= solapamiento < 1.0
...
Uso:
    python scripts/af01_stratify.py \
        ...
        --out scripts/artifacts_science/AF-01
...
def main() -> int:
    ...
    metrics = {
        "metodo": "FND-05/FND-02 (reimplementación AF-01)",
        "k_mer": K_MER,
    ...
    with open(out_dir / "estratos_report.txt", "w", encoding="utf-8") as fh:
        fh.write("AF-01 — solapamiento por receptor (k-mers k=8, SEQRES por cadena)\n\n")
